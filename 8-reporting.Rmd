...
```{r}
filesPerProjectDist(DATASET_NAME, DATASET_PATH)
```
...
```{r}
starsPerProjectDist(DATASET_NAME, DATASET_PATH)
```
...
```{r}
commitsPerProjectDist(DATASET_NAME, DATASET_PATH)
```
